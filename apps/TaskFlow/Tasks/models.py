...
class Categories(models.Model):
    category_name = models.CharField(blank=False,default='', verbose_name="name")
    created_user = models.ForeignKey(User,blank=False,null=True,on_delete=models.CASCADE,related_name="created_user")



class Tasks(models.Model):
    title = models.CharField(blank=False,default='title', verbose_name="title")
    ...
    repeat_days = models.CharField(blank=True,default='', verbose_name="r_days")
...
class UserProfile(models.Model):
    ...
    image = models.CharField(blank=True,default='', null=True)
