...
class TasksSerializer(serializers.ModelSerializer):
    ...
    category = serializers.HiddenField()
    repeat_days = serializers.HiddenField()
    author_info_display = serializers.SerializerMethodField()
    category_display = serializers.SerializerMethodField()
    repeat_days_display = serializers.SerializerMethodField()
    class Meta:
        model = Tasks
        field = ['title','content','time','author_info_display','category_display','repeat_days_display','author','category','repeat_days']
